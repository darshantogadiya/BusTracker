    ...
    componentDidMount() {
        ...
        setInterval(() => {
            ...
            if (new Date().getHours() >= 23) {
                this.setState({
                    surat: false, ankleshwar: true, vadodara: false, anand: false, ahmedabad: false
                })
            }
            else if (new Date().getHours() >= 21) {
                this.setState({
                    surat: true, ankleshwar: false, vadodara: false, anand: false, ahmedabad: false
                })
            }
            else if (new Date().getHours() >= 4) {
                this.setState({
                    surat: false, ankleshwar: false, vadodara: false, anand: false, ahmedabad: true
                })
            }
            else if (new Date().getHours() >= 2) {
                this.setState({
                    surat: false, ankleshwar: false, vadodara: false, anand: true, ahmedabad: false
                })
            }
            else if (new Date().getHours() >= 1) {
                this.setState({
                    surat: false, ankleshwar: false, vadodara: true, anand: false, ahmedabad: false
                })
            }
        }, 1000)
                    ...
                    <View style={{ alignItems: "center", marginHorizontal: 15, elevation: 5, marginTop: 20, backgroundColor: "#F3EFEF", padding: 20, borderRadius: 10 }}>
                        ...
                        <View style={{ flexDirection: "row", width: "100%" }}>
                            <View style={{ width: "18%", alignItems: "center" }}>
                                ...
                                <Text style={{ color: "green", fontWeight: "bold" }}>10 PM</Text>
                                <Text style={{ color: "green", fontWeight: "bold" }}>Surat</Text>
                            </View>
                            <View style={{ width: "2%" }}></View>
                            <View style={{ width: "18%", alignItems: "center" }}>
                                <Text style={{ marginLeft: 5, fontWeight: "bold" }}>|</Text>
                                <Text style={{ color: "grey", fontWeight: "bold" }}>11 PM</Text>
                                <Text style={{ color: "grey", fontWeight: "bold" }}>Ankleshwar</Text>
                            </View>
                            <View style={{ width: "2%" }}></View>
                            <View style={{ width: "18%", alignItems: "center" }}>
                                <Text style={{ marginLeft: 5, fontWeight: "bold" }}>|</Text>
                                <Text style={{ color: "grey", fontWeight: "bold" }}>01 AM</Text>
                                <Text style={{ color: "grey", fontWeight: "bold" }}>Vadodara</Text>
                            </View>
                            <View style={{ width: "2%" }}></View>
                            <View style={{ width: "18%", alignItems: "center" }}>
                                <Text style={{ marginLeft: 5, fontWeight: "bold" }}>|</Text>
                                <Text style={{ color: "grey", fontWeight: "bold" }}>02 AM</Text>
                                <Text style={{ color: "grey", fontWeight: "bold" }}>Anand</Text>
                            </View>
                            <View style={{ width: "2%" }}></View>
                            <View style={{ width: "18%", alignItems: "center" }}>
                                <Text style={{ marginLeft: 5, fontWeight: "bold" }}>|</Text>
                                <Text style={{ color: "red", fontWeight: "bold" }}>04 AM</Text>
                                <Text style={{ color: "red", fontWeight: "bold" }}>Ahmedabad</Text>
                            </View>
                            <View style={{ width: "2%" }}></View>
                        </View>
